...
%% === Step 2: Create 3D Text Letter by Letter (Optimized) ===

%get the inout letters
letters = 'GCGC Data';
fontSize = 15; %font size
depth = 10; %the amount of extruding
spacing = 10; %the spacing between each character
...
combined_vertices = [Solid_vertices; all_text_vertices; num_vertices; v_solid_translated];
combined_faces = [Solid_faces; text_faces_shifted; num_faces_shifted; f_solid_shifted];
% 
